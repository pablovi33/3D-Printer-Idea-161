 ...
 * NEEDS EEPROM CLEAR!!
 */
#define ZPROBE_X_OFFSET        -21.7
#define ZPROBE_Y_OFFSET        -24.8
#define ZPROBE_Z_OFFSET        -2.2
 ...
 * NEEDS EEPROM CLEAR!!
 */
//PRUEBAS CON MODIFICACIONES EN ESTE MARGEN
//MARGEN INICIAL 10
//mARGEN QUE FUNCIONO ES 24
//margen caluclado 26
#define BED_MARGIN 35
/* Extruder Count
 ...
 */
 ...
 //SE Comento porque el segundo extrusor no ha sido reparado
#define E0_STEPS 96
//#define E1_STEPS 96
...
#define CUSTOM_MACHINE_NAME "Delta Rostock G2S"
...
// For the other hotends it is their distance from the extruder 0 hotend.
  ...
  #define HOTEND_OFFSET_Y {0.0, 25.0}  // (in mm) for each extruder, offset of the hotend on the Y axis
#endif
...
#define DELTA
  ...
  //#if ENABLED(LINEAR_PLUS)
    #define DELTA_PRINTABLE_RADIUS 104.0 // mm
  //#else
  ...
  //#else
    #define DELTA_RADIUS 91.53 //mm  Get this value from auto calibrate
  //#endif
